...
namespace InvoiceCafe.Models.Domain
{
    ...
    public class Person
    {
        ...
        public string IdentityDocumentsNames { get; set; } //{JSON string of URIs}
        #endregion
        ...
        public bool UserRestrictions { get; set; } //This field was changed from "2.4.1 table 9.Возможности для пользователя" with accordance V. Uporov requirements.

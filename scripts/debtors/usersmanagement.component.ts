...
@Component({
    ...
    templateUrl: '/templates/v0102/debtors/usersmanagement.tpl.html'
})
export class UsersManagementComponent implements OnInit {
    ...
    navigate_to_add() {
        this._router.navigate(['DebtorHome/AddPerson']);
    }

    navigate_to_update(id) {
        this._router.navigate(['DebtorHome/UpdatePerson', id]);
    }
}
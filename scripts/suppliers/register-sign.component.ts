...
@Component({
    selector: 'ic-sign',
    templateUrl: '/templates/v0102/suppliers/sign.tpl.html'
})
export class SignComponent implements OnInit {
    ...
    constructor(private dataService: DataService, private router: Router, private storService: StorageService, private dict: DictionaryService, private helper: HelperService, private translate: TranslateService) {

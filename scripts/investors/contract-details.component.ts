...
export class ContractDetailsComponent implements OnInit {
    ...
    constructor(private dataService: DataService, private route: ActivatedRoute, private router: Router, private helper: HelperService, private dict: DictionaryService) {

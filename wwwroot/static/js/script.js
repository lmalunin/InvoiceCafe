...
$document.ready(function () {
	...
	if (plugins.calcSlider1.length) {
		...
		var Count = function () {
			...
			n1.html(format(b11) + ' <img src="../../static/img/svg/ruble_medium.svg" width="26">');
			n2.html(format(b12) + ' <img src="../../static/img/svg/ruble_medium.svg" width="26">');
			n3.html(format(b13) + ' <img src="../../static/img/svg/ruble_medium_black.svg" width="26">');

...
var FiltersAddComponent = (function () {
    function FiltersAddComponent(dataService, router, storService, helper) {
        ...
        this.submit_click = function () {
            ...
            this.dataService.addFilterForInvestor(this.filter)
        ...
        this.filter.CompanyId = this.currentCompany.Id;
    ...
    FiltersAddComponent.prototype.set_DebtorDealsDays = function (days) {
    ...
    FiltersAddComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: '/templates/v0102/investors/filters-add.tpl.html'
        }), 

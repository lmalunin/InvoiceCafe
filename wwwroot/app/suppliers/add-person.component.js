...
var AddPersonComponent = (function () {
    ...
    AddPersonComponent.prototype.add_person = function () {
        ...
        this._person.EDS_type = 1; //setup of this field is temporary, only for application correct work.
    ...
    AddPersonComponent.prototype.set_activity = function (value) {
        this._person.IsActive = value;
    };
    __decorate([
        core_1.Input(), 
    ...
    AddPersonComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: '/templates/v0102/suppliers/add-person.tpl.html'
        }), 

...
// ***************************************************************************************
var ContractsEditComponent = (function () {
    function ContractsEditComponent(dataService, router, storService, helper, translate, dict) {
    ...
    ContractsEditComponent.prototype.ngOnInit = function () {
        this.getDebtors();
    };
    ContractsEditComponent.prototype.initialize_model = function () {
        this.model = new ContractViewModel_1.ContractViewModel();
        this.model.SupplierSigner = new PersonViewModel_1.PersonViewModel();
        this.choosedDebtor = new CompanyViewModel_1.CompanyViewModel();
    ...
    ContractsEditComponent.prototype.after_file_upload = function (event) {
    ...
    ContractsEditComponent.prototype.upl_reject = function (event) {
        this.helper.showToast(document.getElementById('theToast'), event.detail.file.name + ' error: ' + event.detail.error);
    };
    ContractsEditComponent.prototype.getDebtors = function () {
        var _this = this;
    ...
    ContractsEditComponent.prototype.calc_contract_duration = function (event) {
    ...
    ContractsEditComponent.prototype.add_contract = function () {
        var _this = this;
    ...
    ContractsEditComponent.prototype.process_error = function (errorObject) {
        this.showProgress = false;
    ...
    ContractsEditComponent.prototype.moveToStep = function (step) {
        this.currentStep = step;
    };
    ContractsEditComponent.prototype.chooseDebtor = function (id) {
        this.choosedDebtor = this.debtors.find(function (d) { return d.Id == id; });
    };
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], ContractsEditComponent.prototype, "_dp_local", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], ContractsEditComponent.prototype, "_upl_local", void 0);
    ContractsEditComponent = __decorate([
        core_1.Component({
            selector: 'ic-contracts-add',
            templateUrl: '/templates/v0102/suppliers/contracts-edit.tpl.html'
        }), 
    ...
    return ContractsEditComponent;
}());
exports.ContractsEditComponent = ContractsEditComponent;

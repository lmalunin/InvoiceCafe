...
var OffersListComponent = (function () {
    function OffersListComponent(dataService, router, storService) {
...
var OfferDetailsComponent = (function () {
    ...
    OfferDetailsComponent.prototype.process_offer_ok = function (offer) {
        ...
        if (offer.Status == 10) {
            ...
            this.helper.showToast(document.getElementById('theToast'), "Offer has been succesfully accepted");
        }
        if (offer.Status == 20)
            this.helper.showToast(document.getElementById('theToast'), "Offer has been rejected");
    };

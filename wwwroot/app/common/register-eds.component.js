...
var EdsComponent = (function () {
    function EdsComponent(dataService, storService, edsService, dict) {
    ...
    EdsComponent = __decorate([
        ...
        __metadata('design:paramtypes', [dataService_1.DataService, storageService_1.StorageService, edsService_1.EDSService, dictService_1.DictionaryService])
    ], EdsComponent);
    return EdsComponent;
}());

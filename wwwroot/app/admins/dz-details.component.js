...
var DZDetailsComponent = (function () {
    function DZDetailsComponent(dataService, route, router, helper) {
        ...
        this.accept_ok = function (appForm) {
            ...
            this.helper.showToast(document.getElementById('theToast'), "Invoice accepted");
            this.model.Status = 5;
        };
        this.submit_click = function () {
            ...
            this.dataService.accept_dz_byadmin(this.model)
    ...
    DZDetailsComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: '/templates/v0102/admins/dz-details.tpl.html'
        }), 

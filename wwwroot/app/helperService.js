...
var HelperService = (function () {
    ...
    HelperService.prototype.showToast = function (toast, message) {
        if (toast) {
            toast.text = message;
            toast.open();
        }
    };
    HelperService.prototype.processUploadFileName = function (localFileName) {
        console.log("before: ", localFileName);
        var serverFileName = localFileName.replace(/;+/g, '-').replace(/\s+/g, '_').replace(/.+/g, '_');
    ...
    HelperService.prototype.mapCompany = function (company, outerObj) {
